              ...
              >
                <Card hoverable className="h-full">
                  <CardContent className="p-3 md:p-5 lg:p-7">
                    <benefit.icon className="h-6 w-6 md:h-9 md:w-9 lg:h-10 lg:w-10 text-[rgb(var(--brand-primary))] mb-2 md:mb-3" />
                    <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold mb-1 md:mb-1.5">{benefit.title}</h3>
                    <p className="text-[10px] sm:text-xs md:text-sm text-[rgb(var(--muted))] leading-relaxed">{benefit.description}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
