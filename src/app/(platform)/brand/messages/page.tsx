...
// Mock conversations (brand perspective)
const mockConversations = [
  {
    id: '1',
    name: 'Sarah Anderson',
    avatar: 'https://via.placeholder.com/100',
    lastMessage: 'I\'d love to collaborate! When should we schedule the call?',
    timestamp: '5m ago',
    unread: 1,
    online: true,
  ...
  },
  {
    ...
    name: 'Michael Chen',
    avatar: 'https://via.placeholder.com/100',
    lastMessage: 'The review video is ready for your approval.',
    timestamp: '2h ago',
    unread: 0,
    online: true,
...
const mockMessages = [
  {
    id: '1',
    sender: 'me',
    message: 'Hi Sarah! Thanks for applying to our Spring Fashion Launch campaign.',
    timestamp: '10:30 AM',
    read: true,
  },
  {
