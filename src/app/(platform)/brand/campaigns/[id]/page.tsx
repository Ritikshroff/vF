...
import { fetchCampaignById, acceptInfluencerForCampaign } from '@/services/campaigns'
...
export default function BrandCampaignDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'applicants' | 'accepted' | 'performance'>('overview')
  ...
  const spotsRemaining = campaign.max_influencers - campaign.accepted_influencers.length
            ...
            <Card className="border-2">
              <CardContent className="p-4 md:p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t border-[rgb(var(--border))]">
                  <div>
                    <div className="text-xs text-[rgb(var(--muted))] mb-1">Budget</div>
                  ...
                  <div>
                    <div className="text-xs text-[rgb(var(--muted))] mb-1">Influencers</div>
                    <div className="text-lg md:text-xl font-bold gradient-text">
                  ...
                  <div>
                    <div className="text-xs text-[rgb(var(--muted))] mb-1">Applicants</div>
                    <div className="text-lg md:text-xl font-bold gradient-text">
                  ...
                  <div>
                    <div className="text-xs text-[rgb(var(--muted))] mb-1">Deadline</div>
                    <div className="text-lg md:text-xl font-bold gradient-text">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm text-[rgb(var(--muted))]">
                        <div>Age: {campaign.target_audience.age_range.join(', ')}</div>
                        <div>Gender: {campaign.target_audience.gender.join(', ')}</div>
                        <div>
                          Locations: {campaign.target_audience.locations.slice(0, 3).join(', ')}
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm text-[rgb(var(--muted))]">
                        <div>
                          Min Followers: {formatCompactNumber(campaign.requirements.min_followers)}
                        </div>
                        <div>
                          Min Engagement: {campaign.requirements.min_engagement_rate}%
                        </div>
                      </div>
                    </div>
                  </CardContent>
                    ...
                    <div className="space-y-3">
                      {campaign.requirements.deliverables.map((deliverable, index) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-sm mb-1">{deliverable.type}</h4>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm text-[rgb(var(--muted))]">Application Deadline</div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="font-semibold">
                          {new Date(campaign.content_due_date).toLocaleDateString()}
                        </div>
                      </div>
                    </div>
                  </CardContent>
                ...
                {acceptedInfluencers.length === 0 ? (
                  <Card className="text-center py-16">
                    <CardContent>
                      ...
                      <h3 className="text-xl font-semibold mb-2">No accepted influencers</h3>
                      <p className="text-[rgb(var(--muted))]">
                ...
                {campaign.performance ? (
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    <Card className="border-2">
                      <CardContent className="p-6">
                        ...
                        <div className="text-sm text-[rgb(var(--muted))]">Total Reach</div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-2">
                      <CardContent className="p-6">
                        ...
                        <div className="text-sm text-[rgb(var(--muted))]">Total Engagement</div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-2">
                      <CardContent className="p-6">
                        ...
                        <div className="text-sm text-[rgb(var(--muted))]">Conversions</div>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-2 border-green-500/20 bg-green-500/5">
                      <CardContent className="p-6">
                        ...
                        <div className="text-sm text-[rgb(var(--muted))]">ROI</div>
                      </CardContent>
                    </Card>
                  </div>
                ) : (
                  <Card className="text-center py-16">
                    <CardContent>
                      ...
                      <p className="text-[rgb(var(--muted))]">
                        Performance metrics will appear once the campaign is active
                      </p>
                    </CardContent>
                  </Card>
                )}
